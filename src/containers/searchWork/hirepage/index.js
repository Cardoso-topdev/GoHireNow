...
class MainLayout extends Component {
  ...
  handleDropClick = (id) => {
    ...
    const newDrops = dropshows.includes(id)
      ? dropshows.filter((dropId) => dropId != id)
      : dropshows.concat(id);
      ...
      <div>
        <div className="hire-want-section new-home2">
          <div className="container">
            <div className="row">
              <div
                className="col-6 hire-page-header-inner"
        ...
        <div className="as-seen-as" style={{ backgroundColor: "#333333" }}>
          <div className="container-fluid d-flex justify-content-center">
            <div
              className="row  black-back-header black-back"
              style={{
                width: "88%",
                padding: "25px 49px",
              }}
        ...
        <div className="container " style={{ marginTop: "0px" }}>
          ...
          >
            <div className="col-md-12 pl-0">
              ...
              >
                Hire top-quality freelancers and virtual assistants for your
                next project or startup.
                <br />
                &nbsp; Learn how you can save more than 82% on salaries. Get
                work done today!
              </h3>
            </div>
          </div>
              ...
              jobtitles.map((item, index) => {
                return [
                    ...
                    <div className="dropdown-hirepage" key={`${index}hirepage`}>
                      ...
                      {/*</button>*/}
                      {
                        <div className="w-25 col-3 pb-2 pt-2 pr-2 pl-2 d-flex  hirepage-job flex-column respsonsive-of-listing-new">
                          ...
                          >
                            <img
                              src={require(`../../../assets/listofjobsassets/${item.name.toUpperCase()}.png`)}
                              style={{
                                marginTop: "24px",
                                marginBottom: "25px",
                                width: "120px",
                  ...
                  <MediaQuery minDeviceWidth="768px">
                    <div
                      className="w-25 col-3 pb-2 pt-2 pr-2 pl-2 d-flex  hirepage-job flex-column
                          ...
                          item.jobTitles.map((ite) => {
                            return (
                              <Link
                                to={`/hire-virtual-assistant/${
                                  ite.friendlyUrl &&
                                  ite.friendlyUrl.replace("/", "").toLowerCase()
                                }/${ite.id}`}
                                className="text-center mt-2 mb-2"
                                style={{
                                  color: "rgb(65, 143, 205)",
...
export default withCookies(
  connect(mapStateToProps, { setUserType })(MainLayout)
);
